...
<<<<<<< HEAD
            index=models.Index(fields=['course', 'status'], name='livestream__course__4a7927_idx'),
        ),
        migrations.AddIndex(
            model_name='livestream',
            index=models.Index(fields=['instructor', '-scheduled_start'], name='livestream__instruc_a69504_idx'),
        ),
        migrations.AddIndex(
            model_name='qaquestion',
            index=models.Index(fields=['stream', '-upvotes'], name='livestream__stream__e04460_idx'),
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['stream', '-created_at'], name='livestream__stream__6f3e0b_idx'),
        ),
        migrations.AddIndex(
            model_name='streamviewer',
            index=models.Index(fields=['stream', 'is_currently_watching'], name='livestream__stream__975863_idx'),
        ),
        migrations.AddIndex(
            model_name='videoconference',
            index=models.Index(fields=['course', '-scheduled_start'], name='livestream__course__0bd81a_idx'),
        ),
        migrations.AddIndex(
            model_name='videoconference',
            index=models.Index(fields=['host', '-scheduled_start'], name='livestream__host_id_74adc1_idx'),
        ),
        migrations.AddIndex(
            model_name='videoconference',
            index=models.Index(fields=['status', '-scheduled_start'], name='livestream__status_ff21dc_idx'),
        ),
        migrations.AddIndex(
            model_name='videoconferenceparticipant',
            index=models.Index(fields=['conference', '-joined_at'], name='livestream__confere_6df0fd_idx'),
        ),
        migrations.AddIndex(
            model_name='videoconferenceparticipant',
            index=models.Index(fields=['user', '-joined_at'], name='livestream__user_id_b9db21_idx'),
=======
