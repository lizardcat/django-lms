...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "max_viewers",
                    models.IntegerField(
                        default=1000, help_text="Maximum concurrent viewers"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "video_file",
                    models.FileField(
                        blank=True, null=True, upload_to="stream_recordings/%Y/%m/"
                    ),
                ),
                (
                    "video_url",
                    models.URLField(
                        blank=True, help_text="External URL if hosted elsewhere"
                    ),
                ),
                (
                    "thumbnail",
                ...
                (
                    "is_public",
                    models.BooleanField(
                        default=False, help_text="Allow non-enrolled students to view"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "description",
                    models.TextField(
                        blank=True, help_text="Meeting description/agenda"
                    ),
                ),
                (
                    "room_name",
                ...
                (
                    "require_password",
                    models.BooleanField(
                        default=False, help_text="Require password to join"
                    ),
                ),
                (
                    "password",
                ...
                (
                    "enable_recording",
                    models.BooleanField(
                        default=False, help_text="Allow meeting recording"
                    ),
                ),
                (
                    "enable_lobby",
                ...
                (
                    "max_participants",
                    models.IntegerField(
                        default=50, help_text="Maximum number of participants"
                    ),
                ),
                (
                    "restrict_to_course",
                ...
                (
                    "recording_url",
                    models.URLField(
                        blank=True, help_text="Recording URL after meeting ends"
                    ),
                ),
                ...
                (
                    "duration_minutes",
                    models.IntegerField(default=0, help_text="Actual meeting duration"),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "duration_minutes",
                    models.IntegerField(
                        default=0, help_text="Time spent in conference (minutes)"
                    ),
                ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["course", "status"], name="livestream__course__6c2b47_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="livestream",
            index=models.Index(
                ...
                name="livestream__instruc_8d4e2f_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="streamviewer",
            index=models.Index(
                fields=["stream", "is_currently_watching"],
                name="livestream__stream__7a3c94_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="streamchat",
            index=models.Index(
                fields=["stream", "-created_at"], name="livestream__stream__9b2e5a_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="qaquestion",
            index=models.Index(
                fields=["stream", "-upvotes"], name="livestream__stream__4c8d1f_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="videoconference",
            index=models.Index(
                fields=["course", "-scheduled_start"],
                name="livestream__course__3f5a2e_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="videoconference",
            index=models.Index(
                ...
                name="livestream__host_id_7e9b1c_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="videoconference",
            index=models.Index(
                ...
                name="livestream__status_6d4c8f_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="videoconferenceparticipant",
            index=models.Index(
                fields=["conference", "-joined_at"],
                name="livestream__confere_2a5e9b_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="videoconferenceparticipant",
            index=models.Index(
                fields=["user", "-joined_at"], name="livestream__user_id_1c4f7d_idx"
            ),
        ),
    ]
